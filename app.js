...
/* Sync method: virtual clock (same approach as Rave)
   When play is pressed, Firebase stores:
     { playing: true, position: X, playedAt: serverTimestamp }
   Any viewer calculates current position as:
     position + (Date.now() - playedAt)
   This means everyone is always in sync regardless of when they join.
*/
...
var clockSyncTimer  = null;  // continuously corrects drift using virtual clock
